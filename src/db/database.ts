...
import type { LocalBook, Bookmark, Highlight, VocabWord } from './types';
export class ReadFlowDB extends Dexie {
  books!: EntityTable<LocalBook,'id'>; bookmarks!:EntityTable<Bookmark,'id'>; highlights!:EntityTable<Highlight,'id'>; vocabulary!:EntityTable<VocabWord,'id'>;
